...
class SoldesProductsController extends AbstractController
{
    ...
    #[Route('/soldes/{title}', name: 'show_solde_products_category')]
    public function showSoldeProductsCategory(
        Categorie $category,
        EntityManagerInterface $entityManager,
        ProductsService $productsService,
        Request $request): Response
    {
        ...
        $products = $productsService->getPaginatedSoldesProductsCategory($category);
        ...
        if ($filterForm->isSubmitted() && $filterForm->isValid()) {
            ...
            // On fait appelle au qb par les repo
            $products = $productsService->getPaginatedSoldesProductsCategoryFiltered(
                $category,
                $color,
                $size,
                $material,
        ...
        return $this->render('soldes_products/soldes_category.html.twig', [
            'newProducts' => $products,
            'category' => $category,
            'categories' => $categories,
            'categoriesMerchandising' => $categoriesMerchandising,
