...
class VetementFemmeCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        yield CollectionField::new('productsQuantities', 'Remplir le formulaire')->useEntryCrudForm(VetementFemmeQuantityNestedCrudController::class)->setRequired(false)->onlyOnForms();
