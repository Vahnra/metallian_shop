...
class VetementMerchandisingShortsCrudController extends AbstractCrudController
{
    ...
    public function persistEntity(EntityManagerInterface $entityManager, $entityInstance): void
    {
        ...
        $entityInstance->setSousCategorieMerchandising($entityManager->getRepository(SousCategorieMerchandising::class)->findOneBy(['title' => 'Shorts', 'categorieMerchandising' => 4]));
