...
class VetementFemmeMerchandisingPantalonsCrudController extends AbstractCrudController
{
    ...
    public function persistEntity(EntityManagerInterface $entityManager, $entityInstance): void
    {
        ...
        $entityInstance->setSousCategorieMerchandising($entityManager->getRepository(SousCategorieMerchandising::class)->findOneBy(['title' => 'Pantalons', 'categorieMerchandising' => 5]));
