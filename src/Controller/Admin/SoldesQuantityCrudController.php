...
class SoldesQuantityCrudController extends AbstractCrudController
{
    public function createIndexQueryBuilder(SearchDto $searchDto, EntityDto $entityDto, FieldCollection $fields, FilterCollection $filters): QueryBuilder
    {
        return parent::createIndexQueryBuilder($searchDto, $entityDto, $fields, $filters)
            ->andWhere('entity.solde = :yes')
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        yield NumberField::new('discount', 'Pourcentage')->setColumns(3);
    ...
    {
        return $crud
            ->setEntityLabelInSingular('Article en solde')
            ->setEntityLabelInPlural('Articles en solde')
        ;
    }
