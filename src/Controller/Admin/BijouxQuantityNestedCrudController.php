...
class BijouxQuantityNestedCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        // yield AssociationField::new('products', 'Bijoux')->setCrudController(BijouxCrudController::class)->autocomplete()->hideOnDetail();
        // yield TextField::new('products.title', 'Bijoux')->onlyOnDetail();
