...
class VetementEnfantNestedQuantityCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        // yield AssociationField::new('products', 'Vêtement')->setCrudController(VetementCrudController::class)->autocomplete()->hideOnDetail();
        // yield TextField::new('products.title', 'Vêtement')->onlyOnDetail();
