...
use App\Controller\Admin\ChaussuresCrudController;
...
class ChaussuresQuantityNestedCrudController extends AbstractCrudController
{
    public function createIndexQueryBuilder(SearchDto $searchDto, EntityDto $entityDto, FieldCollection $fields, FilterCollection $filters): QueryBuilder
    {
        return parent::createIndexQueryBuilder($searchDto, $entityDto, $fields, $filters)
            ->leftJoin('entity.products', 'vqcs')
            ->andWhere('vqcs.type = :chaussure')
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        // yield AssociationField::new('products', 'Chaussures')->setCrudController(ChaussuresCrudController::class)->autocomplete()->hideOnDetail();
        // yield TextField::new('products.title', 'Chaussures')->onlyOnDetail();
