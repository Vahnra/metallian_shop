...
class VetementMerchandisingQuantityNestedCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        // yield TextField::new('products', 'Vêtement merchandising')->onlyOnDetail();
