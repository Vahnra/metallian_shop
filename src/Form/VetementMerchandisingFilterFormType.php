...
class VetementMerchandisingFilterFormType extends AbstractType
{
        ...
        $builder
            ->add('Couleur', ChoiceType::class, [
                ...
                'label_attr' => [
                    'id' => 'color',
                    'class' => 'col-10',
                    'onclick' => 'showColorFilterVetementMerchandising()',
            ...
            ->add('Size', ChoiceType::class, [
                ...
                'label_attr' => [
                    'id' => 'size',
                    'class' => 'col-10',
                    'onclick' => 'showSizeFilterVetementMerchandising()',
                    'style' => 'cursor: pointer;'
                ],
                'required' => false,
            ])
            ->add('material', ChoiceType::class, [
                ...
                'label_attr' => [
                    'id' => 'material',
                    'class' => 'col-10',
                    'onclick' => 'showMaterialFilterVetementMerchandising()',
                    'style' => 'cursor: pointer;'
                ],
                'required' => false,
            ])
            ->add('marque', ChoiceType::class, [
                ...
                'label_attr' => [
                    'id' => 'marque',
                    'class' => 'col-10',
                    'onclick' => 'showMarqueFilterVetementMerchandising()',
                    'style' => 'cursor: pointer;'
                ],
                'required' => false,
            ])
